...
fn main() {
	let (lod, mut root, normals) = Binvox::read_file(format!("data/sponza.binvox"));
	...
	let cam_loc = Point::new(0, 0, view_limit/4);
	let pitch = (0.0).to_radians();
	let yaw = (90.0).to_radians();
	...
	let filename = format!("./renders/sponza{}_{}_{}_{}[{}_{}_{}].ppm",
