...
fn main() {
	let (lod, mut root) = Binvox::read_file("data/lucy_low10.binvox");
	...
	*/
	...
	let cam_loc = Point::new(view_limit/4, 0, -view_limit/2);
	...
	let filename = format!("./renders/lucy_low{}_{}_{}_{}[{}_{}_{}].ppm",
