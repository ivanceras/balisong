...
fn main() {
	let (lod, mut root, normals) = Binvox::read_file(format!("data/dragon9.binvox"));
	...
	let cam_loc = Point::new(view_limit/4,0,-view_limit/4);
	let pitch = (-30.0).to_radians();
	let yaw = (-25.0).to_radians();
	...
	let filename = format!("./renders/dragon{}_{}_{}_{}[{}_{}_{}].ppm",
